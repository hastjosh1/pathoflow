...
/** Soft, modern corner radii applied to all Material components. */
private val PathoFlowShapes =
  Shapes(
...
fun MyApplicationTheme(
  ...
  // Brand teal everywhere: dynamic (wallpaper) color is intentionally disabled
  // so the app looks consistent on every device, including Android 12+.
